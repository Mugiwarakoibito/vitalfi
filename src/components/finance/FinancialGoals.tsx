  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-blue-500/30 bg-black/60 backdrop-blur-[12px] p-5 shadow-lg shadow-blue-500/5">
                ...
                <div className="relative z-10">
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex items-center gap-3">
                      <div className="w-11 h-11 rounded-xl from-purple-500/25 to-violet-500/25 border border-purple-500/30 flex items-center justify-center text-xl shadow-lg" style={{boxShadow: '0 0 20px rgba(139,92,246,0.15)'}}>
                        {category.icon}
                      </div>
                      <div>
