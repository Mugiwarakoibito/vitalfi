      ...
      <div className="space-y-3">
        <div className="flex gap-2">
          <div className="relative flex-1">
            <Search size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-white/70" style={{ zIndex: 50, filter: 'drop-shadow(0 0 6px rgba(255,255,255,0.3))' }} />
            <input
              type="text"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-red-500/30 bg-black/60 backdrop-blur-[12px] p-5 shadow-lg shadow-red-500/5 min-h-[7.5rem]">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-purple-500/30 bg-black/60 backdrop-blur-[12px] p-5 shadow-lg shadow-purple-500/5 min-h-[7.5rem]">
            ...
            <div className="relative">
              ...
              <p className="text-3xl font-bold text-purple-400 drop-shadow-lg">{formatCurrency(totalTransfer, settings.currency || 'USD')}</p>
            </div>
          </div>
        </div>
