                    ...
                    {chartTab === 'progression' && (
                      gainChartData.length > 0 ? (
                                  ...
                                  <div className="relative space-y-2">
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                      <div className="rounded-lg bg-white/[0.03] p-2 text-center">
                                        ...
                                        <div className="text-sm font-bold text-white">{d.current}<span className="text-[9px] font-normal text-gray-500 ml-0.5">lbs</span></div>
                                      </div>
                                      <div className="rounded-lg bg-white/[0.03] p-2 text-center">
                        ...
                        <div className="h-full flex flex-col items-center justify-center text-center">
                          ...
                          <p className="text-gray-500 text-xs max-w-[200px]">Log PRs across multiple exercises to track your strength gains over time</p>
                        </div>
                      )
                    )}
                    {chartTab === 'matrix' && (
